...
class Evaluator:
    def __init__(self, model, pickle_file, split_idx, dataset_root, debug=False):
...
if __name__ == '__main__':
    ...
    for pickle_file, location_name in zip(args.test_pickle_files, args.location_names):
        evaluator = Evaluator(model, pickle_file, args.split_idx, args.dataset_root, args.debug)
